...
function stopMeasure(){interval&&(interval=clearInterval(interval),bpminterval&&(bpminterval=clearInterval(bpminterval)),HRS.disable(),g.setColor(1).drawString("PAUSED",88,20,!0).flip(),g.restoreColors())}var RUNNING=!1;DK08.on("dbltouch",function(a){RUNNING?(stopMeasure(),g.fast(!1),RUNNING=!1):(RUNNING=!0,g.fast(!0),startMeasure())});E.on("kill",function(){stopMeasure()});setTimeout(function(){E.showMessage("Double touch\n to start.\n and stop.","Heart Rate")},500);
